...
def scrape(url): #funcion que raspa las urls.
    ...
    return url, duration
urls = ["a.com", "b.com", "c.com", "d.com", "e.com"]  #lista de urls que queremos raspar.
if __name__ == "__main__":
    pool = Pool(processes=3)  #creamos el pool de procesos con el número de procesos que queremos que se ejecuten en paralelo.
